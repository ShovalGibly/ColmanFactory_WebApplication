...
namespace WebApplication_ColmanFactory.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserID,isEditor,UserName,Password,Address,PhoneNumber")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,isEditor,UserName,Password,Address,PhoneNumber")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();
